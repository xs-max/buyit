...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY29kZS1tYXgiLCJhIjoiY2tpOHRwdXpuMDk1bzJybzV3bWVkZnE3aSJ9.Lg2Rk6tAVOBnB7BP1SQmeA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/code-max/ckia1x5c2d1j819qug0zsxohz',
...
var stripe = Stripe('pk_test_51HwmwNByobw5CeSeFOYTyhGENBf2d6RHcxGDwTOmz9AaWOEtcbollu2l6e7fVYcAqmECI5FLcfI6uPi20Y7VSLNp00qdoaSIHT');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "/api/v1/bookings/checkout-session/".concat(tourId); // 1) Get the session from the server
